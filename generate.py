...
# Alle Werte sind /64-kompatibel (two-stage VAE: width % 64 == 0, height % 64 == 0).
# Größerer Wert ≈ Quality-Target, minimale Ratio-Abweichung.
...
_VIDEO_DIMS: dict[tuple[str, str], tuple[int, int]] = {
    # Generated by tests/values.py — all values % 64 == 0 (two-stage VAE requirement).
    # Larger dimension ≈ quality target. Minimal ratio deviation.
    ("16:9", "240p"): (320, 192),
    ("9:16", "240p"): (192, 320),
    ("21:9", "240p"): (320, 128),
    ("9:21", "240p"): (128, 320),
    ...
    ("1:2",  "1440p"): (704, 1408),
    ("2:1",  "1440p"): (1408, 704),
    ("16:9", "2160p"): (2176, 1216),
    ("9:16", "2160p"): (1216, 2176),
    ("21:9", "2160p"): (2240, 960),
    ("9:21", "2160p"): (960, 2240),
    ("3:2",  "2160p"): (2112, 1408),
    ("2:3",  "2160p"): (1408, 2112),
