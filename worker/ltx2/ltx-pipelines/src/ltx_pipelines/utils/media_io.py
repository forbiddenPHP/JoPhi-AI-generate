...
def encode_video(
    ...
    for video_chunk in tqdm(all_tiles(first_chunk, video), total=video_chunks_number, desc="Encoding video"):
...
def decode_audio_from_file(
    ...
    # Audio VAE expects stereo (2 channels) — duplicate mono if needed
